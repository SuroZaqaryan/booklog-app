...
const DialogTitle = ({
  ...
  return (
    <ReactDialog.Title className={cn("text-lg font-semibold", className)} {...props}>
      {children}
    </ReactDialog.Title>
  );
};
...
const DialogDescription = ({
  ...
  return (
    <ReactDialog.Description className={cn("text-sm text-muted-foreground", className)} {...props}>
      {children}
...
export { DialogTrigger, DialogHeader, DialogContent, DialogTitle, DialogDescription, DialogFooter };
